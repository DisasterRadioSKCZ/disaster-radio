...
{
	printf("(    (  / ___)/ _\\/ ___(_  _(  __(  _ \\ (  _ \\/ _\\(    (  /  \\\r\n"); 
	printf(") D ()(\\___ /    \\___ \\ )(  ) _) )   /_ )   /    \\) D ()(  O )\r\n");
        printf("(____(__(____\\_/\\_(____/(__)(____(__\\_(_(__\\_\\_/\\_(____(__\\__/\r\n");
        printf("                   ____ __ _     ___ ____                      \r\n");
        printf("                  / ___(  / ___ / __(__  )                    \r\n");
        printf("                  \\___ \\)  (___( (__ / _/                      \r\n");
        printf("                  (____(__\\_)   \\___(____)                     \r\n");
  printf("v1.0.0-rc.2 EU\r\n");
  #ifndef SIM
  /*
